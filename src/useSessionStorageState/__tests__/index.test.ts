...
describe('useSessionStorageState', () => {
  test('initial value', () => {
    ...
    const { result } = renderHook(() => useSessionStorageState(storageKey, { defaultValue: "default value" }))
  ...
  test('save array', () => {
    ...
    const { result } = renderHook(() => useSessionStorageState<Array<number>>(storageKey, { defaultValue: [] }))
