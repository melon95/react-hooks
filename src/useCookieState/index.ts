...
const useCookieState = (key: string, options: Options = {}): [string | undefined, SetState] => {
  ...
  const updateCookieState = useCallback((value: SetStateAction<string | undefined>, newOptions: Options = {}) => {
